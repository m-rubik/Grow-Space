...
def manually_generate_config_file(name):
    RGB_data = {}
    RGB_data['0'] = {"R": 200, "G": 0, "B": 200}
    RGB_data['1'] = {"R": 200, "G": 0, "B": 200}
    RGB_data['2'] = {"R": 200, "G": 0, "B": 200}
    RGB_data['3'] = {"R": 200, "G": 0, "B": 200}
    RGB_data['4'] = {"R": 200, "G": 0, "B": 200}
    RGB_data['5'] = {"R": 200, "G": 0, "B": 200}
    RGB_data['6'] = {"R": 200, "G": 50, "B": 200}
    RGB_data['7'] = {"R": 200, "G": 100, "B": 200}
    RGB_data['8'] = {"R": 200, "G": 150, "B": 200}
    RGB_data['9'] = {"R": 200, "G": 200, "B": 200}
    RGB_data['10'] = {"R": 200, "G": 200, "B": 200}
    RGB_data['11'] = {"R": 200, "G": 200, "B": 200}
    RGB_data['12'] = {"R": 200, "G": 200, "B": 200}
    RGB_data['13'] = {"R": 200, "G": 200, "B": 200}
    RGB_data['14'] = {"R": 200, "G": 200, "B": 200}
    RGB_data['15'] = {"R": 200, "G": 200, "B": 200}
    RGB_data['16'] = {"R": 200, "G": 200, "B": 200}
    RGB_data['17'] = {"R": 200, "G": 200, "B": 200}
    RGB_data['18'] = {"R": 200, "G": 150, "B": 200}
    RGB_data['19'] = {"R": 200, "G": 100, "B": 200}
    RGB_data['20'] = {"R": 200, "G": 50, "B": 200}
    RGB_data['21'] = {"R": 200, "G": 0, "B": 200}
    RGB_data['22'] = {"R": 200, "G": 0, "B": 200}
    RGB_data['23'] = {"R": 2000, "G": 0, "B": 200}
