...
class GrowSpaceGUI:
    ...
    def control_window(self):
        ...
        if not self.control_window_open:
            ...
            self.control_win.UV_OFF = Button(self.control_win, bg="White", fg="Black", text="OFF", font="Helvetica 20 bold", command=lambda: self.queue_out.put("UV OFF"))
            self.control_win.UV_ON = Button(self.control_win, bg="White", fg="Black", text="ON",  font="Helvetica 20 bold", command=lambda: self.queue_out.put("UV ON"))
            self.control_win.Fan_OFF = Button(self.control_win, bg="White", fg="Black", text="OFF",  font="Helvetica 20 bold", command=lambda: self.queue_out.put("Fan OFF"))
            self.control_win.Fan_ON = Button(self.control_win, bg="White", fg="Black", text="ON",  font="Helvetica 20 bold", command=lambda: self.queue_out.put("Fan ON"))
            self.control_win.Pump_OFF = Button(self.control_win, bg="White", fg="Black", text="OFF",  font="Helvetica 20 bold", command=lambda: self.queue_out.put("Pump OFF"))
            self.control_win.Pump_ON = Button(self.control_win, bg="White", fg="Black", text="ON",  font="Helvetica 20 bold", command=lambda: self.queue_out.put("Pump ON"))
    ...
    def configure_window(self):
        ...
        if not self.configure_window_open:
            ...
            self.configure_win.EnvironmentalParametersHeader = Label(self.configure_win, bg="Black", fg="White", text="Environmental Parameters", font="Helvetica 22 bold")
